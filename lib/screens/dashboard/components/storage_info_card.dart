...
class StorageInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(top: Style.defaultPadding),
      padding: EdgeInsets.all(Style.defaultPadding),
      decoration: BoxDecoration(
        border: Border.all(width: 2, color: Style.primaryColor.withOpacity(0.15)),
        borderRadius: const BorderRadius.all(
          Radius.circular(Style.defaultPadding),
        ),
      ),
      child: Row(
        children: [
